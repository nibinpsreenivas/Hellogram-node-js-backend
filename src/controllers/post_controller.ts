...
export const createNewPost = async (req: Request, res: Response): Promise<Response> => {
    ...
    try {
        ...
        const { comment, type_privacy,post_emotion}: INewPost = req.body;
        ...
        await conn.query('INSERT INTO posts (uid, type_privacy, person_uid,post_emotion) value (?,?,?,?)', [uidPost, type_privacy, req.idPerson, post_emotion]);
